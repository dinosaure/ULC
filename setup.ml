...
(* OASIS_START *)
(* DO NOT EDIT (digest: 097a6c368cf6a86617a59dc83f1cdb2f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Untyped Lambda Calculus in OCaml";
          description = None;
          categories = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-w"; "-20"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-w"; "-20"])]
                   },
                   {exec_custom = false; exec_main_is = "ulc.ml"})
            ];
          plugins =
            [(`Extra, "DevFiles", Some "0.3"); (`Extra, "META", Some "0.4")];
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "K\163\215\148\030\n\205\244F'\174\186\132\219\245\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
